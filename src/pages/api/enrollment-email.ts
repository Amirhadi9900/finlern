...
const REDIRECT_URI = 'https://developers.google.com/oauthplayground'; // This should be a URL your app controls, but for getting refresh token, playground is fine
