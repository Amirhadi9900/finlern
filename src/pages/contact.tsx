          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              >
                ...
                <div className="p-8 text-center">
                  ...
                  <div className="space-y-3">
                    <p className="text-gray-600">Finlern Language Center</p>
                    <p className="text-xl font-bold text-aurora-purple">
                      Kaakonojantie<br />
                      Valkeakoski, Finland
                    </p>
            ...
            <div className="mt-16 text-center" data-aos="fade-up" data-aos-duration="800">
              ...
              <div className="flex justify-center items-center space-x-6">
                ...
                <a 
                  href="#" 
                  className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center text-white transform transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="Twitter"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
