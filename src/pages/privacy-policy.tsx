      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto prose prose-lg prose-p:text-gray-700 prose-li:text-gray-700">
            <p>
              Welcome to FinLern, an educational chat application designed to facilitate communication and resource sharing among students, teachers, and administrators. This Privacy Policy explains how we collect, use, disclose, and protect your information when you use FinLern (the "App"). Your privacy is important to us, and we are committed to safeguarding your personal data in compliance with the General Data Protection Regulation (GDPR), the Finnish Data Protection Act, and other applicable laws.
            </p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">1. Who We Are</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">2. Information We Collect</h2>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">c. Information Processed via Third-Party Services</h3>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">3. How We Use Your Information</h2>
            <p>
              We use your information for the following purposes, based on legal grounds under the GDPR:
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">a. To Provide and Operate the App (Contractual Necessity, GDPR Art. 6(1)(b))</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">b. To Improve and Maintain the App (Legitimate Interest, GDPR Art. 6(1)(f))</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">c. To Comply with Legal Obligations (Legal Obligation, GDPR Art. 6(1)(c))</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">d. With Your Consent (Consent, GDPR Art. 6(1)(a))</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">4. Data Retention</h2>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">5. How We Share Your Information</h2>
            <p>
              We do not sell your personal data. We share it only in these cases:
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">a. With Service Providers</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">b. Within the App</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">c. Legal Requirements</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">6. Data Security</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">7. Your Rights Under GDPR</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">8. International Data Transfers</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">9. Children's Privacy</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">10. Changes to This Privacy Policy</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-aurora-purple mt-8 mb-4">11. Contact Us</h2>
            <p>
